...
const nextConfig: NextConfig = {
  ...
  output: "standalone",
  // O type-check roda localmente (npm run build) e na suíte de testes. Pulá-lo no
  // build de produção evita o OOM na etapa "Running TypeScript" do servidor
  // compartilhado do Coolify (dezenas de containers, memória apertada), onde o
  // processo era morto logo após compilar.
